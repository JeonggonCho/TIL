...
3. [Filtering data](#3-filtering-data)
    - [Filtering data 관련 키워드](#1-filtering-data-관련-키워드)
    - [DISTINCT](#2-distinct)
    ...
    - [Logical Operator](#5-logical-operator)
    - [IN Operator](#6-in-operator)
    - [LIKE Operator](#7-like-operator)
    - [Wildcard Characters](#8-wildcard-characters)
    - [LIMIT Clause](#9-limit-clause)
