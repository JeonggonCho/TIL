...
1. [Template System](#1-template-system)
    - [Django Template Language(DTL)](#1-django-template-languagedtl)
    - [DTL Syntax](#2-dtl-syntax)
        - [Variable](#--variable)
        - [Filters](#--filters)
        - [Tags](#--tags)
        - [Comments](#--comments)
...
4. [요청과 응답 예시](#4-요청과-응답-예시)
    - [입력을 받아 그대로 출력](#1-입력을-받아-그대로-출력)
        - [입력 받는 기능](#--입력-받는-기능)
        - [출력 기능](#--출력-기능)
5. [참고](#5-참고)
    - [템플릿 경로 지정](#1-템플릿-경로-지정)
        - [BASE_DIR](#--base_dir)
    - [DTL 주의사항](#2-dtl-주의사항)
...
- 예를 들어 웹 페이지의 head, navbar, footer 등은 `공통 레이아웃`이므로 모든 템플릿에서 중복해서 작성하는 것은 `비효율적`임
  ...
  ![템플릿 공통요소](../img/django_template_inheritance.png)
