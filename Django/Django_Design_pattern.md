...
1. [Django 프로젝트와 앱](#1-django-프로젝트와-앱)
    - [Django project](#1-django-project)
    - [Django application](#2-django-application)
        - [프로젝트, 앱 예시](#--프로젝트-앱-예시)
        - [앱 생성](#--앱-생성)
        - [앱 등록](#--앱-등록)
2. [Django 디자인 패턴](#2-django-디자인-패턴)
    - [디자인 패턴](#1-디자인-패턴)
    - [MVC 디자인 패턴](#2-mvc-디자인-패턴)
    - [MTV 디자인 패턴](#3-mtv-디자인-패턴)
    - [프로젝트 구조](#4-프로젝트-구조)
    - [앱 구조](#5-앱-구조)
3. [요청과 응답](#3-요청과-응답)
    - [URLs](#1-urls)
    ...
    - [Template](#3-template)
        ...
        - [코드 작성](#--코드-작성)
4. [참고](#4-참고)
    - [MTV 디자인 패턴 정리](#1-mtv-디자인-패턴-정리)
    - [왜 Django는 MTV라고 하는가?](#2-왜-django는-mtv라고-하는가)
    - [render 함수](#3-render-함수)

---

## (1) Django 프로젝트와 앱

![Django 프로젝트와 앱](../img/django_project,app.jpg)
...
![MVC 디자인 패턴](../img/django_MVC_pattern.png)
...
![MTV 디자인 패턴](../img/django_MTV_pattern.png)
...
![템플릿 폴더](../img/django_templates_folder.png)
