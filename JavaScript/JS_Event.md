...
1. [이벤트](#1-이벤트)
    - [event](#1-event)
    - [event 종류](#2-event-종류)
    - [event handler](#3-event-handler)
        - [.addEventListener()](#--addeventlistener)
        - [event handler 예시](#--event-handler-예시)
2. [이벤트 핸들러 활용](#2-이벤트-핸들러-활용)
    - [click 이벤트](#1-click-이벤트)
    - [input 이벤트](#2-input-이벤트)
    - [click & input 이벤트](#3-click--input-이벤트)
    - [이벤트 취소하기](#4-이벤트-취소하기)
        - [.preventDefault()](#--preventdefault)
    - [간단한 To do 만들기](#5-간단한-to-do-만들기)
    - [로또 번호 생성기 예시](#6-로또-번호-생성기-예시)
        - [lodash](#--lodash)
3. [참고](#3-참고)
    - [addEventListener와 this](#1-addeventlistener와-this)
